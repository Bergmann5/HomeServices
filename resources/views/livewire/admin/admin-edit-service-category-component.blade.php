                            ...
                            <div class="panel-body">
                                ...
                                <form action="" class="form-horizontal" wire:submit.prevent="updateServiceCategory">
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="form-label col-sm-3">Category Name:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Category Slug:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="form-label col-sm-3">Category image:</label>
                                        <div class="col-sm-9">
