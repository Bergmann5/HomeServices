                        ...
                        <div class="col-md-8 col-md-offset-2 profile1">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="" class="form-horizontal" wire:submit.prevent="updateService">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Slug:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Tagline:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Service Category:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Price:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Discount:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Discount Type:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Featured:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Description:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Inclusion:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="form-label col-sm-3">Exclusion:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="form-label col-sm-3">Thumbnail:</label>
                                        <div class="col-sm-9">
