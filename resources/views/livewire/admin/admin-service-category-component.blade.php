                        ...
                        <div class="col-md-12 profile1">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-md-6">
                                            All Service Categopries
                                        </div>
                                        <div class="col-md-6">
                        <a href="{{route('admin.add_service_cat')}}" class="btn btn-info pull-right">Add New</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($scategories as $scategory)
                                                <tr>
                                                    ...
                                                    <a href="{{route('admin.edit_cat',['category_id'=>$scategory->id])}}"><i class="fa fa-edit fa-2x text-info"></i></a>
