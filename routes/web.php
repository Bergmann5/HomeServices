...
Route::get('/service_categories',ServiceCategoriesComponent::class)->name('home.service_cat');
...
//for Admin
    ...
    Route::get('/admin/service-category/add',AdminAddServiceCategoryComponent::class)->name('admin.add_service_cat');
    Route::get('/admin/service-category/edit/{category_id}',AdminEditServiceCategoryComponent::class)->name('admin.edit_cat');
